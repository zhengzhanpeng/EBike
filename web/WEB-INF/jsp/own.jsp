    ...
    <div class="mui-inner-wrap">
        ...
        <div id="content-m" class="mui-content mui-scroll-wrapper">
            ...
            <div class="mui-button-row">
                <button id="add-own" class="mui-btn-primary">欠款录入</button>
                    ...
                    <c:forEach items="${list}" var="ownUnique">
                        <li class="mui-table-view-cell mui-collapse">
                            ...
                            <div class="mui-collapse-content">
                                ...
                                <div class="colorId mui-hidden">${ownUnique.colorId}</div>
                                ...
                                <div class="mui-button-row">
                                    ...
                                    <button type="button" class="repay-input btn-m mui-btn-success ">还款录入</button>
...
//            mui.alert(str, "还款记录");
        ...
        //录入还款
        $(".repay-input").click(function () {
            var id = $(this).parent().prevAll(".ownId").text();
            layer.open({
                type: 2
                , content: 'html/repayModel.html'
                , title: "还款录入"
                , area: ['90%', '380px']
                , btn: ['录入', '取消']
                , yes: function (index, layero) {
                    ...
                    var repayDate = layer.getChildFrame("#repayDate").val();
                    //发送ajax
                    $.ajax({
                        type: "post",
                        url: "addOwnMessage.do"
                        , data: {"ownId": id, "money": money, "remark": remark, "setDateStr": repayDate}
        ...
        $("#search-btn").click(function () {
            var str = $("#search").val();
            if(str == "") {
                window.location.href = "own.do";
                return;
            }
            window.location.href = str + "/searchOwn.do";
        })
        ...
        $("#order").click(function () {
            ...
            orderPicker.show(function(rs) {
                ...
                var str = $("#search").val();
                if(str == "") {
                    window.location.href = order + "/orderOwn.do"
                } else {
                    window.location.href = order + "/"+ str + "/orderOwn.do"
                }
            })
        });
        //降序排序
